...
{
    public class DataExtractionServiceTest : IDisposable
    {
        ...
        [Theory]
        [InlineData("steelplaza-meldingresult-oneskill")]
        [InlineData("guildhall-meldingresult-twoskill")]
        [InlineData("steelplaza-meldingresult-0-0-0")]
        [InlineData("steelplaza-meldingresult-1-0-0")]
        [InlineData("steelplaza-meldingresult-1-1-0")]
        [InlineData("steelplaza-meldingresult-1-1-1")]
        [InlineData("steelplaza-meldingresult-2-0-0")]
        [InlineData("steelplaza-meldingresult-2-1-0")]
        ...
        [InlineData("steelplaza-meldingresult-deco1")]
        [InlineData("steelplaza-meldingresult-deco2")]
        [InlineData("steelplaza-meldingresult-deco3")]
        ...
        [InlineData("steelplaza-meld-3-2-0")]
        ...
        [InlineData("steelplaza-meld-deco1")]
